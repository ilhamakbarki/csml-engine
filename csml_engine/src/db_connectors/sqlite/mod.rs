...
#[tracing::instrument(name = "db.sqlite.setup.init", skip_all, fields(db_system = "sqlite"))]
...
#[tracing::instrument(name = "db.sqlite.setup.migrate", skip_all, fields(db_system = "sqlite"))]
