...
#[tracing::instrument(name = "db.sqlite.conversation.create", skip_all, fields(otel.kind = "client", db.system = "sqlite", db.operation = "insert", db.collection = "csml_conversations", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), flow_id = crate::utils::trunc(flow_id), step_id = crate::utils::trunc(step_id)))]
...
#[tracing::instrument(name = "db.sqlite.conversation.close", skip_all, fields(otel.kind = "client", db.system = "sqlite", db.operation = "update", db.collection = "csml_conversations", bot_id = crate::utils::trunc(&_client.bot_id), channel_id = crate::utils::trunc(&_client.channel_id), status = crate::utils::trunc(status)))]
...
#[tracing::instrument(name = "db.sqlite.conversation.close_all", skip_all, fields(otel.kind = "client", db.system = "sqlite", db.operation = "update", db.collection = "csml_conversations", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.sqlite.conversation.get_latest_open", skip_all, fields(otel.kind = "client", db.system = "sqlite", db.operation = "select", db.collection = "csml_conversations", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.sqlite.conversation.update", skip_all, fields(otel.kind = "client", db.system = "sqlite", db.operation = "update", db.collection = "csml_conversations", flow_id = ?flow_id, step_id = ?step_id))]
...
#[tracing::instrument(name = "db.sqlite.conversation.delete_user", skip_all, fields(otel.kind = "client", db.system = "sqlite", db.operation = "delete", db.collection = "csml_conversations", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.sqlite.conversation.list", skip_all, fields(otel.kind = "client", db.system = "sqlite", db.operation = "select", db.collection = "csml_conversations", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), db.limit = limit.unwrap_or(0) as i64, db_paginated = pagination_key.is_some()))]
...
#[tracing::instrument(name = "db.sqlite.conversation.delete_all_bot_data", skip_all, fields(otel.kind = "client", db.system = "sqlite", db.operation = "delete", db.collection = "csml_conversations", bot_id = crate::utils::trunc(bot_id)))]
