...
#[tracing::instrument(name = "db.setup.init", skip_all, fields(otel.kind = "internal", db.layer = "dispatch"))]
...
#[tracing::instrument(name = "db.setup.migrate", skip_all, fields(otel.kind = "internal", db.layer = "dispatch"))]
