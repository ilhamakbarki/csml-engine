...
#[tracing::instrument(name = "db.pg.message.add_bulk", skip_all, fields(otel.kind = "client", db.system = "postgresql", db.operation = "insert", db.collection = "csml_messages", bot_id = crate::utils::trunc(&data.client.bot_id), channel_id = crate::utils::trunc(&data.client.channel_id), direction = crate::utils::trunc(direction), db.batch_size = msgs.len() as i64))]
...
#[tracing::instrument(name = "db.pg.message.delete_user", skip_all, fields(otel.kind = "client", db.system = "postgresql", db.operation = "delete", db.collection = "csml_messages", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.pg.message.list", skip_all, fields(otel.kind = "client", db.system = "postgresql", db.operation = "select", db.collection = "csml_messages", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), db.limit = limit.unwrap_or(0) as i64, db_paginated = pagination_key.is_some(), db_from_date = ?from_date, db_to_date = ?to_date))]
