...
#[tracing::instrument(name = "db.pg.message.add_bulk", skip_all, fields(db_system = "postgresql", db_operation = "insert", db_sql_table = "csml_messages", bot_id = crate::utils::trunc(&data.client.bot_id), channel_id = crate::utils::trunc(&data.client.channel_id), direction = crate::utils::trunc(direction), db_batch_size = msgs.len() as i64))]
...
#[tracing::instrument(name = "db.pg.message.delete_user", skip_all, fields(db_system = "postgresql", db_operation = "delete", db_sql_table = "csml_messages", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.pg.message.list", skip_all, fields(db_system = "postgresql", db_operation = "select", db_sql_table = "csml_messages", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), db_limit = ?limit, db_paginated = pagination_key.is_some(), db_from_date = ?from_date, db_to_date = ?to_date))]
