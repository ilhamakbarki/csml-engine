...
#[tracing::instrument(name = "db.memory.add_batch", skip_all, fields(otel.kind = "internal", db.layer = "dispatch", db.operation = "insert", bot_id = crate::utils::trunc(&data.client.bot_id), channel_id = crate::utils::trunc(&data.client.channel_id), db.batch_size = memories.len() as i64))]
pub fn add_memories(
...
#[tracing::instrument(name = "db.memory.create", skip_all, fields(otel.kind = "internal", db.layer = "dispatch", db.operation = "insert", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), memory_key = crate::utils::trunc(&key)))]
...
#[tracing::instrument(name = "db.memory.get_all_internal", skip_all, fields(otel.kind = "internal", db.layer = "dispatch", db.operation = "select", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
 ...
 * Get client Memories
 */
#[tracing::instrument(name = "db.memory.get_all", skip_all, fields(otel.kind = "internal", db.layer = "dispatch", db.operation = "select", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
 ...
 * Get client Memory
 */
#[tracing::instrument(name = "db.memory.get", skip_all, fields(otel.kind = "internal", db.layer = "dispatch", db.operation = "select", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), memory_key = crate::utils::trunc(key)))]
...
#[tracing::instrument(name = "db.memory.delete", skip_all, fields(otel.kind = "internal", db.layer = "dispatch", db.operation = "delete", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), memory_key = crate::utils::trunc(key)))]
...
#[tracing::instrument(name = "db.memory.delete_all", skip_all, fields(otel.kind = "internal", db.layer = "dispatch", db.operation = "delete", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
