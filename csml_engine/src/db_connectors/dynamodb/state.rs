...
#[tracing::instrument(name = "db.dynamo.state.delete_key", skip_all, fields(db_system = "dynamodb", db_operation = "DeleteItem", db_collection = "state", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), state_type = crate::utils::trunc(_type), state_key = crate::utils::trunc(key)))]
...
#[tracing::instrument(name = "db.dynamo.state.get_key", skip_all, fields(db_system = "dynamodb", db_operation = "GetItem", db_collection = "state", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), state_type = crate::utils::trunc(_type), state_key = crate::utils::trunc(key)))]
...
#[tracing::instrument(name = "db.dynamo.state.get_current", skip_all, fields(db_system = "dynamodb", db_operation = "GetItem", db_collection = "state", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.dynamo.state.set_items", skip_all, fields(db_system = "dynamodb", db_operation = "BatchWriteItem", db_collection = "state", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), state_type = crate::utils::trunc(_type), db_batch_size = keys_values.len() as i64))]
...
#[tracing::instrument(level = "debug", name = "db.dynamo.state.query", skip_all, fields(db_system = "dynamodb", db_operation = "Query", db_collection = "state", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), db_limit = limit))]
fn query_states(
    client: &Client,
    db: &mut DynamoDbClient,
    limit: i64,
...
#[tracing::instrument(name = "db.dynamo.state.delete_user", skip_all, fields(db_system = "dynamodb", db_operation = "BatchWriteItem", db_collection = "state", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
