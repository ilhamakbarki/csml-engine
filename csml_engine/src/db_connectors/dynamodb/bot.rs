...
#[tracing::instrument(name = "db.dynamo.bot.create_version", skip_all, fields(db_system = "dynamodb", db_operation = "PutItem", db_collection = "bot", bot_id = crate::utils::trunc(&bot_id)))]
...
#[tracing::instrument(name = "db.dynamo.bot.get_flows", skip_all, fields(db_system = "dynamodb", db_operation = "GetObject", s3_key = crate::utils::trunc(key)))]
...
#[tracing::instrument(name = "db.dynamo.bot.get_modules", skip_all, fields(db_system = "dynamodb", db_operation = "GetObject", s3_key = crate::utils::trunc(key)))]
...
#[tracing::instrument(level = "debug", name = "db.dynamo.bot.query_versions", skip_all, fields(db_system = "dynamodb", db_operation = "Query", db_collection = "bot", bot_id = crate::utils::trunc(bot_id), db_limit = limit, db_paginated = pagination_key.is_some()))]
...
#[tracing::instrument(name = "db.dynamo.bot.list_versions", skip_all, fields(db_system = "dynamodb", db_operation = "Query", db_collection = "bot", bot_id = crate::utils::trunc(bot_id), db_limit = ?limit, db_paginated = pagination_key.is_some()))]
...
#[tracing::instrument(name = "db.dynamo.bot.get_by_version_id", skip_all, fields(db_system = "dynamodb", db_operation = "GetItem", db_collection = "bot", bot_id = crate::utils::trunc(bot_id), version_id = crate::utils::trunc(version_id)))]
...
#[tracing::instrument(name = "db.dynamo.bot.get_last_version", skip_all, fields(db_system = "dynamodb", db_operation = "Query", db_collection = "bot", bot_id = crate::utils::trunc(bot_id)))]
...
#[tracing::instrument(name = "db.dynamo.bot.delete_version", skip_all, fields(db_system = "dynamodb", db_operation = "DeleteItem", db_collection = "bot", bot_id = crate::utils::trunc(bot_id), version_id = crate::utils::trunc(version_id)))]
...
#[tracing::instrument(name = "db.dynamo.bot.delete_versions", skip_all, fields(db_system = "dynamodb", db_operation = "BatchWriteItem", db_collection = "bot", bot_id = crate::utils::trunc(bot_id)))]
...
#[tracing::instrument(level = "debug", name = "db.dynamo.bot.query_info", skip_all, fields(db_system = "dynamodb", db_operation = "Query", db_collection = crate::utils::trunc(class), bot_id = crate::utils::trunc(bot_id), db_limit = limit))]
fn query_bot_info(
    bot_id: &str,
    class: &str,
    limit: i64,
...
#[tracing::instrument(name = "db.dynamo.bot.delete_all_data", skip_all, fields(db_system = "dynamodb", db_operation = "BatchWriteItem", db_collection = crate::utils::trunc(class), bot_id = crate::utils::trunc(bot_id)))]
