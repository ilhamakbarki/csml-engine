...
#[tracing::instrument(name = "db.conversation.create", skip_all, fields(db_layer = "dispatch", db_operation = "insert", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), flow_id = crate::utils::trunc(flow_id), step_id = crate::utils::trunc(step_id)))]
...
#[tracing::instrument(name = "db.conversation.close", skip_all, fields(db_layer = "dispatch", db_operation = "update", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.conversation.close_all", skip_all, fields(db_layer = "dispatch", db_operation = "update", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.conversation.get_latest_open", skip_all, fields(db_layer = "dispatch", db_operation = "select", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
...
#[tracing::instrument(name = "db.conversation.update", skip_all, fields(db_layer = "dispatch", db_operation = "update", bot_id = crate::utils::trunc(&data.client.bot_id), channel_id = crate::utils::trunc(&data.client.channel_id), flow_id = ?flow_id, step_id = ?step_id))]
...
#[tracing::instrument(name = "db.conversation.list", skip_all, fields(db_layer = "dispatch", db_operation = "select", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id), db_limit = ?limit, db_paginated = pagination_key.is_some()))]
