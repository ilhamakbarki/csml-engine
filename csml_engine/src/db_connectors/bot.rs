...
#[tracing::instrument(name = "db.bot.create_version", skip_all, fields(db_layer = "dispatch", db_operation = "insert", bot_id = crate::utils::trunc(&bot_id)))]
...
#[tracing::instrument(name = "db.bot.get_last_version", skip_all, fields(db_layer = "dispatch", db_operation = "select", bot_id = crate::utils::trunc(bot_id)))]
...
#[tracing::instrument(name = "db.bot.get_by_version_id", skip_all, fields(db_layer = "dispatch", db_operation = "select", bot_id = crate::utils::trunc(_bot_id), version_id = crate::utils::trunc(version_id)))]
...
#[tracing::instrument(name = "db.bot.list_versions", skip_all, fields(db_layer = "dispatch", db_operation = "select", bot_id = crate::utils::trunc(bot_id), db_limit = ?limit, db_paginated = pagination_key.is_some()))]
...
#[tracing::instrument(name = "db.bot.delete_version", skip_all, fields(db_layer = "dispatch", db_operation = "delete", bot_id = crate::utils::trunc(_bot_id), version_id = crate::utils::trunc(version_id)))]
...
#[tracing::instrument(name = "db.bot.delete_versions", skip_all, fields(db_layer = "dispatch", db_operation = "delete", bot_id = crate::utils::trunc(bot_id)))]
...
#[tracing::instrument(name = "db.bot.delete_all_data", skip_all, fields(db_layer = "dispatch", db_operation = "delete", bot_id = crate::utils::trunc(bot_id)))]
