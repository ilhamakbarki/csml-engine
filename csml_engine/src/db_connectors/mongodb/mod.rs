...
#[tracing::instrument(name = "db.mongo.setup.init", skip_all, fields(db_system = "mongodb"))]
...
#[tracing::instrument(name = "db.mongo.setup.create_ttl_indexes", skip_all, fields(db_system = "mongodb", db_operation = "create_index"))]
...
#[tracing::instrument(name = "db.mongo.setup.create_client_indexes", skip_all, fields(db_system = "mongodb", db_operation = "create_index"))]
