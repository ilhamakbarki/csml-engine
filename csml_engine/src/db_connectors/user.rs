...
#[tracing::instrument(name = "db.client.delete", skip_all, fields(otel.kind = "internal", db.layer = "dispatch", db.operation = "delete", bot_id = crate::utils::trunc(&client.bot_id), channel_id = crate::utils::trunc(&client.channel_id)))]
